package com.bekkestad.controller;
...
import com.bekkestad.controller.SecurityController;
import com.bekkestad.model.Credentials;
import com.bekkestad.model.UserDTO;
import com.bekkestad.model.UserEntity;
import com.bekkestad.repository.UserRepository;
import com.bekkestad.repository.UserRepositoryImpl;
import com.bekkestad.service.UserService;
import com.bekkestad.service.UserServiceImpl;
...
public class SecurityControllerTest {
	...
	public static Archive<?> createDeployment(){		
		return ShrinkWrap.create(WebArchive.class, "login.war")
					.addClasses(UserEntity.class, UserDTO.class, UserRepository.class, UserRepositoryImpl.class,
